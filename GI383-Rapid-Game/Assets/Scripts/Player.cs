...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool isMovementLocked = dashing || isJumpStarting || isLanding || isAttacking || isHit;
    ...
    private void UpdateAnimationState()
    {
        ...
        // Priority: Hit > Attack > Dash > Jump > Move/Idle
        ...
        // If we are doing a High Priority action (Dash, Attack, Jump/Fall), disable basic ground movement animations
        if (dashing || isAttacking || !isGrounded)
        {
            anim.SetBool("IsIdle", false);
            anim.SetBool("IsWalk", false);
        }
    ...
    void FixedUpdate()
    {
        ...
        if (isJumpStarting || isLanding || isAttacking || isHit)
        {
